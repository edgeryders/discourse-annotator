  ...
  RSpec.describe AnnotationsController, type: :controller do
    ...
    describe 'POST create' do
      describe 'with valid params' do
        it 'creates a new DiscourseAnnotator::Annotation' do
          expect do
            parameters = valid_params
            parameters[:format] = :json
            post :create, parameters
          end.to change(DiscourseAnnotator::Annotation, :count).by(1)
        end
        ...
        it 'assigns a newly created annotation as @annotation' do
          ...
          parameters[:format] = :json
          post :create, parameters
          expect(assigns(:annotation)).to be_a(DiscourseAnnotator::Annotation)
