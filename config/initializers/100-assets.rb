...
Rails.application.config.assets.paths << Rails.root.join("app", "assets", "javascripts", "annotator_store")
Rails.application.config.assets.paths << Rails.root.join("app", "assets", "stylesheets", "annotator_store")
